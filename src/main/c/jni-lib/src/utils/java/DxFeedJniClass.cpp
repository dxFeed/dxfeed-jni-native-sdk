...
namespace dxfeed::jni {
  DxJni::DxJni(JNIEnv* env):
    dxEndpointJniClass_(cast<jclass>(env->NewGlobalRef(safeFindClass(env,"Lcom/dxfeed/api/DxEndpointJni;")))),
    dxFeedJniClass_(cast<jclass>(env->NewGlobalRef(safeFindClass(env, "Lcom/dxfeed/api/DxFeedJni;")))),
    dxSubscriptionJniClass_(cast<jclass>(env->NewGlobalRef(safeFindClass(env, "Lcom/dxfeed/api/DxSubscriptionJni;")))),
    dxSymbolJniClass_(cast<jclass>(env->NewGlobalRef(safeFindClass(env, "Lcom/dxfeed/api/DxSymbolJni;"))))
  {
