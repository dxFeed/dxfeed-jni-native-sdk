...
dxfg_observable_subscription_change_listener_t *dxfg_ObservableSubscriptionChangeListener_new(
    graal_isolatethread_t *thread, dxfg_ObservableSubscriptionChangeListener_function_symbolsAdded fSymbolsAdded,
    ...
    auto *pDxStateChangeListener = dxfeed::DxSubscriptionChangeListener::create(thread, fSymbolsAdded, fSymbolsRemoved,
                                                                                fSubscriptionClosed, userData);
