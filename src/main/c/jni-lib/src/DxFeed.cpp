...
DxFeed::DxFeed(JNIEnv *env, jobject dxFeed) : dxFeed_(env->NewGlobalRef(dxFeed)) {
}
...
dxfg_event_type_t *DxFeed::getLastEventIfSubscribed(JNIEnv *env, dxfg_event_clazz_t eventTypeClass,
    ...
    auto jNativeEventsList =
        checkedCallStaticObjectMethod(env, jDxFeedJniClazz, methodId, dxFeed_, jEventTypeClazz, jSymbol);
...
void DxFeed::getLastEvents(JNIEnv *env, dxfg_event_type_list *pList) {
    ...
    auto jNativeEventsList =
        checkedCallStaticObjectMethod(env, jDxFeedJniClazz, methodId, dxFeed_, jClassArray, jStringArray);
    if (jNativeEventsList) {
...
dxfg_event_type_list *DxFeed::getIndexedEventsIfSubscribed(JNIEnv *env, dxfg_event_clazz_t clazz,
    ...
    const char *methodSignature = "(Lcom/dxfeed/api/DXFeed;Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;)Lcom/"
                                  "dxfeed/api/NativeEventsList;";
    auto methodId = safeGetStaticMethodID(env, jDxFeedJniClazz, methodName, methodSignature);
    ...
    auto jNativeEventsList =
        checkedCallStaticObjectMethod(env, jDxFeedJniClazz, methodId, dxFeed_, jEventTypeClass, jSymbol, jSource);
...
dxfg_event_type_list *DxFeed::getTimeSeriesIfSubscribed(JNIEnv *env, dxfg_event_clazz_t clazz,
                                                        dxfg_symbol_t *pSymbolType, int64_t fromTime, int64_t toTime) {
    auto jDxFeedJniClazz = safeFindClass(env, DX_FEED_JNI_CLASS_NAME);
