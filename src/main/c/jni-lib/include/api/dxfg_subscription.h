...
typedef void (* dxfg_ObservableSubscriptionChangeListener_function_symbolsAdded)(graal_isolatethread_t* thread,
                                                                                 dxfg_symbol_list* symbols,
                                                                                 void* user_data);
typedef void (* dxfg_ObservableSubscriptionChangeListener_function_symbolsRemoved)(graal_isolatethread_t* thread,
                                                                                   dxfg_symbol_list* symbols,
                                                                                   void* user_data);
typedef void (* dxfg_ObservableSubscriptionChangeListener_function_subscriptionClosed)(graal_isolatethread_t* thread,
                                                                                       void* user_data);
...
int32_t                   dxfg_DXFeedSubscription_containsEventType(graal_isolatethread_t* thread,
                                                                    dxfg_subscription_t* sub,
...
int32_t                   dxfg_DXFeedSubscription_setSymbols(graal_isolatethread_t* thread, dxfg_subscription_t* sub,
                                                             dxfg_symbol_list* symbols);
dxfg_symbol_list*         dxfg_DXFeedSubscription_getDecoratedSymbols(graal_isolatethread_t* thread,
                                                                      dxfg_subscription_t* sub);
