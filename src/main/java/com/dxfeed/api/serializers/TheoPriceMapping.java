...
public class TheoPriceMapping {
  ...
  public static void toNative(TheoPrice event, ByteBuffer pBytes, DoubleBuffer pDoubles) {
    // BYTE DATA
  ...
  public static TheoPrice fromNative(ByteReader reader) {
